...
#### Examples
1. Solve the equation \( f(x) = x^3 - 4x + 1 = 0 \) using the Bisection Method with initial guesses \( a = 0 \) and \( b = 2 \) with two decimal precision.
...
| 3         | 0.00   | 0.50   | 0.25             | 1.00     | -0.875   | 0.2344    | [0.25, 0.50]        |
| 4         | 0.25   | 0.50   | 0.375            | 0.2344   | -0.875   | -0.3652   | [0.25, 0.375]       |
| 5         | 0.25   | 0.375  | 0.3125           | 0.2344   | -0.3652  | -0.0825   | [0.25, 0.3125]      |
| 6         | 0.25   | 0.3125 | 0.2813           | 0.2344   | -0.0825  | 0.0731    | [0.2813, 0.3125]    |
| 7         | 0.2813 | 0.3125 | 0.2969           | 0.0731   | -0.0825  | -0.0040   | [0.2813, 0.2969]    |
| 8         | 0.2813 | 0.2969 | 0.2891           | 0.0731   | -0.0040  | 0.0343    | [0.2891, 0.2969]    |
| 9         | 0.2891 | 0.2969 | 0.2930           | 0.0343   | -0.0040  | 0.0151    | [0.2930, 0.2969]    |
| 10        | 0.2930 | 0.2969 | 0.2950           | 0.0151   | -0.0040  | 0.0056    | [0.2950, 0.2969]    |

After 10 iterations, values of a,b and c are same upto two decimal places, so the root of given equation is 0.2950.

### Stopping Criteria
- The stopping criterion can be based on the interval width, \(|b - a|\), being sufficiently small.
- For two significant figures, we might stop once \(|b - a| < 0.01\).

Stopping at the 10th iteration achieves this precision:
- \( a = 0.2950 \)
- \( b = 0.2969 \)
- \( |b - a| = 0.0019 \)
